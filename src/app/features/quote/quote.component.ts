...
@Component({
  selector: 'app-quote',
  imports: [TabsModule, DialogModule,FormsModule,
    InputNumberModule, SpeedDialModule, CommonModule,
    MultiSelectModule, DropdownModule, ButtonModule, 
    TextareaModule, InputTextModule, ReactiveFormsModule,
    CheckboxModule, SelectModule, CardModule],
    standalone: true,
...
export class QuoteComponent implements OnInit {
  ...
  additionPriceForm: FormGroup | any;
    ...
    this.items = [
      {
          ...
          command: () => {
            ...
            this.messageService.add({severity:'success', summary: 'Cálculo por hora', detail: 'O cálculo do orçamento foi alterado para hora!'});
          }
      },
      {
          ...
          command: () => {
            ...
            this.generateTextBudget();
            this.messageService.add({severity:'success', summary: 'Cálculo por centímetro', detail: 'O cálculo do orçamento foi alterado para centímetro!'});            
          }
      }
    ]
  }
  ...
  copyText() {    
    ...
    this.messageService.add({severity:'success', summary: 'Orçamento copiado', detail: 'O orçamento foi copiado para a área de transferência!'});    
  }
  ...
  setListEnum(enumType: any /*EnumType*/, list: any) {
    // switch(enumType) {
